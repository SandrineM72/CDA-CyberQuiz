...
function Layout(t0) {
    ...
    if ($[0] !== "243a65ea5a568b4b1580cd56c0c92c4a8b8a85d28fbda4d0ca926bd0fb854cb5") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "243a65ea5a568b4b1580cd56c0c92c4a8b8a85d28fbda4d0ca926bd0fb854cb5";
    }
    const { children, pageTitle } = t0;
    const t1 = `My app - ${pageTitle}`;
    let t2;
    if ($[1] !== t1) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5ca034ca._.js.map